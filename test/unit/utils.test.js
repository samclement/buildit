...
test('normalizeLink', (t) => {
  ...
  t.equal(utils.normalizeLink(`bar.html`, deepLinkDocParsedUrl), `http://www.topshop.com/foo/bar.html`, `should resolve path based on currnet url (resource)`)
  t.equal(utils.normalizeLink(`bar.html`, deepLinkDirParsedUrl), `http://www.topshop.com/foo/bar/bar.html`, `should resolve path based on current url (directory)`)
  t.equal(utils.normalizeLink(`bar.html`, deepLinkDocParsedUrl1), `https://www.polymer-project.org/1.0/start/first-element/bar.html`, `should resolve long path base on current url (resource)`)
})
